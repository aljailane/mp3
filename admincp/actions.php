...
if($_GET['act'] == 'editset') {
    ...
    if($_GET['sphp']) { // edit settings.php
	 ...
	 if($_GET['rtxt']) { // edit robots.txt
        
        $file = MAI_ROOT."/robots.txt";
        if(!file_exists($file))
            die("File does not exists !");
        
        $links[] = mai_img("arr.gif")." $lang->edit robots.txt";
       ...
       &#187; <a href='?act=editset&sphp=1'>$lang->edit settings.php</a><br/>
       &#187; <a href='?act=editset&rtxt=1'>$lang->edit robots.txt</a>
		";
