...
function ads_install(){
	...
	"value" => $db->escape("<div class='ad'><a href='http://mirazmac.info'>عينة نص الإعلان الارتباط في تذييل الصفحة</a></div>"), 
	"title" => "تذييل الصفحة الإعلانية", 
